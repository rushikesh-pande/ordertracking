...
```bash
# Clone the repo
git clone https://github.com/rushikesh-pande/ordertracking.git
cd ordertracking
...
Open a [Discussion](https://github.com/rushikesh-pande/ordertracking/discussions) or
