package com.ordertracking.monitoring.aspect;
...
public class MonitoringAspect {
    ...
    public Object monitorControllerMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        String metricName = "ordertracking.controller.duration";
        ...
        try {
            ...
            Counter.builder("ordertracking.controller.errors")
    ...
    public Object monitorServiceMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            meterRegistry.timer("ordertracking.service.duration",
